...
import { updatePokemonReview, deletePokemonReview } from "@/lib/actions/pokemon";
...
interface PokemonReviewItemProps {
  review: PokemonReview;
}

export function PokemonReviewItem({ review }: PokemonReviewItemProps) {
  ...
  async function handleSaveEdit() {
    ...
    startTransition(async () => {
      const result = await updatePokemonReview(review.id, {
  ...
  async function handleDelete() {
    setError(null);
    startTransition(async () => {
      const result = await deletePokemonReview(review.id);
      if (!result.success) {
        setError(result.error);
      }
    });
